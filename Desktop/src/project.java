...
public class project extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            String query = "SELECT * FROM stylysts" +" WHERE user_name=? and password=? ";
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/stylyst1","root","Hilal.anarsay9");
                    pst = con.prepareStatement(query);
                    
                            pst.setString(1,input1.getText().toString());
                            pst.setString(2,input2.getText().toString());
                            rs = pst.executeQuery();
                            if(rs.next()){
                                JOptionPane.showMessageDialog(this,"user name and password matched! Welcome to STYLYST " + rs.getString("user_name"));
                            }
                            else{
